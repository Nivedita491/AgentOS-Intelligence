/**
 * Standard error codes and HTTP status mapping for the AgentOS Intelligence
 * Structured API Validation Layer.
 *
 * Every Edode Function / API endpoint returns these standardized machine-readable
 * error codes so the frontend can render friendly, consistent error states.
 */
...
/** HTTP status code mapping for each standardized error code. */
...
/** Human-friendly default message for each error code. */
...
/** Maps an HTTP status code back to the most likely standardized error code. */
